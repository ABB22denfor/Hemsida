...
const firebaseConfig = {
  ...
  databaseURL: "https://kylskap-c5f3b-default-rtdb.europe-west1.firebasedatabase.app",
...
streamData.on("child_added", (snapshot) => {
  ...
  console.log("tempvalue: " + tempValue + " humValue: " + humValue + " countValue: " + countValue);
